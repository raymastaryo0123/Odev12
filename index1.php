...
<div class="container ">
		...
		<a><img src="logo/logoA.SVG" class="img-fluid"></a>
</div>
		...
		<input type="button" class="col-auto bg-dark text-white rounded mx-2" onClick="location.href='https://enderdersanesi.herokuapp.com/'" value="Gelirler" /></a>
</div>
     	<div class="col-auto text-white rounded mx-2">
		<a href="#" class="text-white">
			<input type="button" class="col-auto bg-dark text-white rounded mx-2" onClick="location.href='https://enderdersanesi.herokuapp.com/index1.php#'" value="Giderler" /></a>
</div>	
</div>
</div>
</div>
